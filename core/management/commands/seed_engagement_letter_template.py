        ...
        with open(docx_path, "rb") as f:
            template = LegalDocumentTemplate(
                ...
                variable_schema={
                    ...
                    "show_service_financial_statements": "boolean",
                    "show_service_tax_return": "boolean",
                    "show_service_bas": "boolean",
                    "show_service_bookkeeping": "boolean",
                    "show_service_tax_planning": "boolean",
                    "show_service_payroll": "boolean",
                    "show_service_asic": "boolean",
                    "show_service_trust_distribution": "boolean",
                    "show_service_trust_deed_review": "boolean",
                    "show_service_div7a": "boolean",
                    "show_service_fbt": "boolean",
                    "show_service_tpar": "boolean",
                    "show_service_dividend_management": "boolean",
                    "show_service_directors_report": "boolean",
                    "show_service_partner_statements": "boolean",
                    "show_service_partnership_agreement_review": "boolean",
                    "show_service_smsf_audit": "boolean",
                    "show_service_smsf_compliance": "boolean",
                    "show_service_member_statements": "boolean",
