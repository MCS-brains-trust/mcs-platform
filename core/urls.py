...
urlpatterns = [
    ...
    path("years/<uuid:pk>/reverse-tax-journal/", views.reverse_tax_journal, name="reverse_tax_journal"),
    ...
    path("htmx/jt-client-prefill/<str:xpm_client_id>/", views.htmx_jt_client_prefill, name="htmx_jt_client_prefill"),
