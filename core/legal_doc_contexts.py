...
# ---------------------------------------------------------------------------
# Standard disclaimer and firm details — loaded from FirmSettings at runtime
# ---------------------------------------------------------------------------
def _get_standard_disclaimer():
    """Return the disclaimer text, using FirmSettings if available."""
    try:
...
# Backward-compat module-level names (resolved lazily at first use)
...
def FIRM_DETAILS():
    """Return firm details dict from FirmSettings (called at context-build time)."""
    return _get_firm_details()
